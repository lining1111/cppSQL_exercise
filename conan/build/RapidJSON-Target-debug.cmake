...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET rapidjson
                 ...
                 $<$<CONFIG:Debug>:${rapidjson_LINKER_FLAGS_DEBUG}>)
    set_property(TARGET rapidjson
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${rapidjson_INCLUDE_DIRS_DEBUG}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET rapidjson
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${rapidjson_LIB_DIRS_DEBUG}>)
    set_property(TARGET rapidjson
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${rapidjson_COMPILE_DEFINITIONS_DEBUG}>)
    set_property(TARGET rapidjson
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${rapidjson_COMPILE_OPTIONS_DEBUG}>)
